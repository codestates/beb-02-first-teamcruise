...
module.exports = async (req, res) => {
    console.log('getWhoesNFT api is calling...');
    
    const web3 = getWeb3();
    // console.log(web3);

    // const account = '0xc2F5c15608a36eA38a7e8464254C230aca2cf4A1'; // account 1 => 이거 받아오는걸로 수정하기
    // const erc721Addr = '0x88877046D5a59B9DE8E475D425521625A4a77345';

    console.log('getWhoesNFT query', req.query);
    ...
    .json({
        ...
        message: 'get Whoes NFTs successfully'
    });
